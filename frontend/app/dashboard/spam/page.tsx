  ...
  return (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 flex items-center gap-2">🚫 Spam Folder</h1>
        ...
        <div className="flex-1 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
          <div className="bg-red-50 px-6 py-3 border-b border-red-100">
            <p className="text-sm text-red-700 font-medium">
              ⚠️ These submissions were blocked by Layer 1 Spam Filter. Mark as "Not Spam" if incorrectly classified.
            </p>
          </div>
            ...
            <div className="divide-y divide-slate-50">
              {leads.map(lead => (
                <div key={lead.id}
                  ...
                  <div className="w-10 h-10 bg-red-100 rounded-full flex items-center justify-center text-red-600 text-xs font-bold flex-shrink-0">
                    🚫
                  </div>
          ...
          <div className="w-80 flex-shrink-0 bg-white rounded-2xl border border-slate-100 shadow-sm p-6 h-fit sticky top-8">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-xl transition disabled:opacity-60"
              >
                {processing === selected.id ? '⏳ Processing...' : '✅ Not Spam — Move to CRM'}
              </button>
              ...
              <button
                ...
                disabled={processing === selected.id}
                className="w-full py-2.5 border border-red-200 text-red-600 text-sm font-medium rounded-xl hover:bg-red-50 transition disabled:opacity-60"
              >
                🗑 Delete Permanently
              </button>
            </div>
